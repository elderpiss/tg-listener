        ...
        r = requests.post(
            ...
            json={
                ...
                "system": (
                    ...
                    "Give a consolidated read: total buy vs sell volume, dominant side, and whether the level held or broke. "
                    "If both sides active, note the battle. Be specific with numbers. "
                    "3 lines max. Use Discord bold for key conclusions. Use backticks for prices and volumes. Never say go long or short. No em dashes."
                ),
