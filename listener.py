        ...
        r = requests.post(
            ...
            json={
                ...
                "system": (
                    ...
                    "Start with a one-line verdict in bold: either 'Level held' or 'Level broke' or 'Battle at level' depending on what happened. "
                    "Then explain in plain simple English what buyers and sellers did, with specific contract numbers. "
                    "Avoid jargon. Write like you are texting a fellow trader a quick update. "
